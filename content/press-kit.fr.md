...
Nous avons construit happyDomain parce que nous voulons faire gagner du temps aux équipes opérationnelles, en leur donnant des super-pouvoirs :
avoir un contrôle total sur leurs domaines tant en production qu'en interne, sans avoir à lire et apprendre tous les nouveaux standards, en restant concentré sur les besoins organisationnels.
...
[Regardez notre article de blog.](https://blog.happydomain.org/fr/happydomain-simplifions-l-usage-des-noms-de-domaines/)
...
Les étudiants s'étonnent de la complexité, par ailleurs Pierre-Olivier se rend compte que personne à son travail ne veut faire des mises à jour de domaine.
...
Pour la partie DNS, nous nous appuyons sur des dépendances robustes, telles que :
- L'incroyable [bibliothèque DNS de miekg](https://github.com/miekg/dns), utilisée entre-autre par [CoreDNS](https://coredns.io/), au cœur de Kubernetes.
...
Pensez au temps passé régulièrement sur des questions de DNS : à traiter avec les interfaces obscures des fournisseurs ou en faisant face à leur manque de fonctionnalités.
...
Avec happyDomain, chaque demande organisationnelle ou de client peut être traitée en quelques secondes sans crainte ni doute, même sans avoir à chercher un tutoriel ou une documentation trop technique.
...
happyDomain est construit par un groupe de personnes basées à Paris, en France.
Entre autre, [Pierre-Olivier](https://nemunai.re/) dirige les développements et Frédéric fédère l'équipe.
...
chaque service est expliqué en détail, vous êtes guidés à chaque étape.
...
Nous proposerons une telle fonctionnalité dans un avenir proche, car elle figure dans notre manifeste. Nous avons choisi de nous concentrer d'abord sur la diffusion de l'idée que les noms de domaine sont accessibles à tout le monde via cette douce interface, avant de nous attaquer à la vie privée, la censure, ...
